/// Maritime Identification Digits (MID) to country name.
///
/// The first three digits of an AIS MMSI identify the issuing country.
const Map<String, String> kMidCountries = {
  '201': 'Albania',
  '202': 'Andorra',
  '203': 'Austria',
  '204': 'Azores (Portugal)',
...
/// Returns the country name for an MMSI (first three digits) or null.
String? midCountryOf(String mmsi) {
  if (mmsi.length < 3) return null;
  return kMidCountries[mmsi.substring(0, 3)];
}
