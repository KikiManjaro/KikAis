...
String logMessageText(AppLocalizations l10n, LogMessage m) => switch (m.key) {
  ...
  'feedDisconnected' => l10n.logFeedDisconnected(_s(m.args['name'])),
  ...
  'tcpClientDisconnected' => l10n.logTcpClientDisconnected(_s(m.args['name'])),
  'tcpClientError' => l10n.logTcpClientError(
    _s(m.args['error']),
    _s(m.args['name']),
  ),
  'sendError' => l10n.logSendError(_s(m.args['error']), _s(m.args['name'])),
  ...
  'rtlSdrError' => l10n.logRtlSdrError(
    _s(m.args['device']),
    _s(m.args['error']),
  ),
